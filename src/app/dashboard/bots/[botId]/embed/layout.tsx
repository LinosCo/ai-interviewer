...
export default async function EmbedPreviewLayout({
    children,
}: {
    ...
    return (
        <div className="flex flex-col md:flex-row h-screen overflow-hidden font-sans" style={{ background: gradients.mesh }}>
            ...
            {/* Main Content Area - NO platform chatbot on this page */}
            ...
            {/* Platform chatbot intentionally omitted to avoid conflicts with widget preview */}
        </div>
    );
}
