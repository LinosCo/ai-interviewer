...
import { ArrowLeft, Link2, AlertCircle, Globe, ExternalLink } from 'lucide-react';
...
export default function ConnectWordPressPage() {
    ...
    const docs = {
        ...
        appPasswords: 'https://developer.wordpress.org/advanced-administration/security/application-passwords/',
    };
                ...
                <div className="pt-4">
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                        ...
                        <div className="text-xs text-blue-900 leading-relaxed space-y-2">
                            ...
                            <p>2. Verifica che l&apos;endpoint MCP risponda (es. <code>https://tuosito.it/wp-json/mcp/v1</code>).</p>
                            <p>
                                3. Crea una Application Password per l&apos;utente WordPress che userai in questa connessione.
                                {' '}
                                <a
                                    href={docs.appPasswords}
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="underline font-semibold"
                                >
                                    Guida Application Passwords
                                </a>
                            </p>
                        </div>
                    </div>
