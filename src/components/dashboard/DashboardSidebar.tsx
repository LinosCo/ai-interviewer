        ...
        <>
            ...
            `}>
                ...
                <nav className="flex flex-col gap-2 flex-1 overflow-y-auto scrollbar-hide pr-2 -mr-2">
                    ...
                    <DashboardLink href="/dashboard/visibility" icon={<Icons.Search size={20} />} label="Visibility Tracker" onClick={() => setIsOpen(false)} />
                    <DashboardLink href="/dashboard/insights" icon={<Icons.Layers size={20} />} label="Unified Insights" onClick={() => setIsOpen(false)} />
