...
import { AlertCircle, FolderKanban, Loader2, CreditCard, BarChart3, Settings2, Lock, Unlock, Bot, Globe, Layers, Quote, ChevronDown, Link2, Brain, Timer, Activity } from 'lucide-react';
...
export const Icons = {
    ...
    Link: (props: IconProps) => <Link2 {...props} />,
